...
describe Strawman::GlypeProxy do
  ...
  it "should be able to validate the given proxy" do
    EventMachine::MockHttpRequest.register_file("http://proxy.com:80/browse.php?u=Oi8vd2hhdGlzbXlpcC5vcmc%3D%0A&f=norefer",
                                                :get,
  ...
  it "should be able to return a proxy url for any given url" do
    @proxy.proxy_url(@proxy_check_url).to_s.should == "http://proxy.com/browse.php?u=Oi8vd2hhdGlzbXlpcC5vcmc%3D%0A&f=norefer"
  end
